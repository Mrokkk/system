...
help:
	...
	@echo "  To compile kernel for another architecture, run either"
	@echo "  'make ARCH=x' or 'make CROSS-COMPILE=y', where 'x' should be" 
	@echo "  selected target architecture and 'y' should be selected GCC"
	@echo "  tools prefix (eg. i686-elf-). In last case target architecture"
	@echo "  would be resolved."
	@echo "  The default architecture is x86."
	@echo "Supported compilers:"
	@echo "  gcc (tested: 4.8.2, 4.9.3, 5.3.0, 6.0.0)"
	...
	@echo "  Windows /w Cygwin (tested with i686-elf cross-compiler)"
